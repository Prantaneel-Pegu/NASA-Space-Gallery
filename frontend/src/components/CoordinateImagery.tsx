...
function CoordinateImagery() {
    ...
    const [mainImageSrc, setMainImageSrc] = useState(
        `api/staticmap?lat=${coordinates.latitude}&long=${coordinates.longitude}&zoom=${coordinates.zoom}&width=${imageWidth}&height=${imageHeight}&isClient=false`
    );
    ...
    function handleSubmit(e: FormEvent<HTMLFormElement>) {
        ...
        setMainImageSrc(
            `api/staticmap?lat=${newCoordinates.latitude}&long=${
                newCoordinates.longitude
            }&zoom=${
                newCoordinates.zoom
            }&width=${imageWidth}&height=${imageHeight}&isClient=false&random=${Math.random()}`
        );
    ...
    return (
        <div id="CoordinateImagery">
            <h1 id="ci-heading">Coordinate Satellite Imagery</h1>
            <p id="ci-desc">Find satellite imagery for a given coordinate.</p>
                ...
                <form method="POST" id="ci-form" onSubmit={handleSubmit}>
                    <fieldset id="ci-form-fieldset">
                        ...
                        <div id="ci-form-latitude-container">
                            <label
                                id="ci-form-lat-label"
                                htmlFor="ci-form-latitude"
                            >
                                Latitude: &nbsp;&nbsp;
                            </label>
                            <input
                        ...
                        <div id="ci-form-longitude-container">
                            <label
                                id="ci-form-lon-label"
                                htmlFor="ci-form-longitude"
                            >
                                Longitude:
                            </label>
                            <input
                        ...
                        <div id="ci-form-zoom-container">
                            <label
                                id="ci-form-zoom-label"
                                htmlFor="ci-form-zoom"
                            >
                                Zoom Level:
                            </label>
                            <select
                        ...
                        <button id="ci-form-submit-btn" type="submit">
                            Submit
                        </button>
                    </fieldset>
                </form>

                {!imgLoaded && searchPending && !imgTimedOut ? (
                ...
                {imgTimedOut && !imgLoaded ? (
                    <div id="ci-img-timedout">
                        ...
                        <p id="ci-timedout-desc">
                            There is probably an error on the server side.
                ...
                {coordinates.latitude && coordinates.longitude ? (
                    ...
                    >
                        <div id="ci-img-data-container">
                            <div
                                id="ci-main-image-container"
                                style={imgLoaded ? {} : { display: "none" }}
                            >
                                <img
                                    src={
                                        coordinates.latitude ? mainImageSrc : ""
                                    }
                                    alt="Coordinate image captured by a satellite"
                                    id="ci-main-image"
                                    onLoad={() => {
                            ...
                            <p
                                ...
                                style={
                                    imgLoaded &&
                                    imgLoadEndTime - imgLoadStartTime > 0
                                        ? {}
                                        : { display: "none" }
                                }
                            >
                                Finished loading in{" "}
                                {(imgLoadEndTime - imgLoadStartTime) / 1000}s.
                            </p>
                        </div>
                    </div>
                ) : null}
