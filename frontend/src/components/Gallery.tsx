...
function Gallery() {
    ...
    const lastServerResponse = useRef({
        ...getImagesPrototype,
        errorElement: <></>,
    });
    const imagesLoaded = useRef(0);
    const galleryImageQuery = useRef("galaxies"); // initial gallery search
    ...
    function loadGalleryImages(numberToLoad = 20) {
        ...
        getImages(
            galleryImageQuery.current,
            imagesLoaded.current + numberToLoad
        ).then((rawServerResponse) => {
            initialLoaded.current = true;
            const serverResponse: GetImageResults & {
                errorElement: JSX.Element;
            } = { ...rawServerResponse, errorElement: <></> };
            ...
            if (serverResponse.error !== "") {
                ...
                const errorElement = (
                    <div id="gallery-error">
                        <p id="gallery-error-text">{serverResponse.error}</p>
                    </div>
                );
                ...
                console.error(
                    "Encountered error in gallery images: ",
            ...
            const newGalleryImages: GetImageResults = {
                ...rawServerResponse,
                results: resultTiles,
            };

            console.log(
                !isEqual(galleryImages, newGalleryImages),
                galleryImages,
                newGalleryImages
            );
    ...
    if (
        ...
        searchParams.get("search") !== searchQuery.query
    ) {
        ...
        return (
            <div id="Gallery">
                <SearchComponent
                    ...
                    newSubmitEvent={newSubmitEvent}
                    setNewSubmitEvent={setNewSubmitEvent}
        ...
        <div id="Gallery">
            ...
            <div id="gallery-image-grid">
                <InfiniteScroll
                    ...
                    hasMore={
                        (galleryImages.numberOfResults !==
                            galleryImages.results.length &&
                            galleryImages.error === "") ||
