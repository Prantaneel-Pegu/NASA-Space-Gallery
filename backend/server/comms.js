...
async function getImages(query, index = "20") {
    ...
    try {
        serverResponse = (await axios_1.default.get(reqUrl, {
...
async function getRoverPhotos(request) {
    ...
    try {
        ...
        manifestRequestResponse = (await axios_1.default.get(manifestReqUrl, {
            signal: AbortSignal.timeout(requestTimeout),
        })).data.photo_manifest;
    }
    catch (err) {
...
async function getStaticMap(latitude, longitude, width, height, zoom, isClient) {
    ...
    try {
        serverResponse = (await axios_1.default.get((0, signUrl_js_1.default)(reqUrl, MAP_URL_SIGNING_SECRET), {
